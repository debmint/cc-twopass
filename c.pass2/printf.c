/* ******************************************** *
 * This is a custom printf routine for c.pass2  *
 *                                              *
 * It follows part 5 in the linkage             *
 * ******************************************** */

/* $Id: printf.c 16 2008-05-04 21:33:05Z dlb $ */
...
{
    D001b.CR = fp;
    DestFlg = 2;      /* Flag that D001b is char * rather than CRLE * */
    L2d8c (fmt, &vals);
    *(D001b.CR) = '\0';
}
...
void
L2d8c (register char *fmt, int *_vals)
#else
...
#endif
{
    ...
    if (_nmbr < 0)     /* else L52ca */
    {
        ...
        {
            return (strcpy (D0286, "-32768"));   /* goto L546c */
        }
        else
        {
            *(myptr++) = '-';
...
#endif
{
    char *_finalstr = D0286;
    int v0;

    register char *regptr = D0290;
